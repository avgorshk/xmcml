...
namespace WindowsServiceControlFileSystem
{
    ...
    public partial class WebMCMLService : ServiceBase
    {
        public WebMCMLService()
        {
            InitializeComponent();
        }
        private String TASKS_FOLDER;
        private String RESULTS_FOLDER;
        private String PROG_PATH;
        private String TMP_FOLDER;
        private String TMP_IMAGE_FOLDER;
        private String TMP_LOGO_FOLDER;
        private String TMP_SURFACE_FOLDER;
        ...
        private List<InfoOfTask> tasks = new List<InfoOfTask>();

        delegate void MAIN_LOOP();
        ...
        private List<int> GetID(String state)
        {
        ...
        private InfoOfTask ParseInfo(String info)
        {
        ...
        private void AddMessageInLog(string message)
        {
        ...
        private void CreateDirectoryTask(String pathDirectory)
        {
        ...
        private void ChangeStateInfoFile(int id, String NEW_STATE)
        {
        ...
        private void CreateFileOutInfo(int id, System.Diagnostics.Process proc)
        {
        ...
        private void DeleteFolderTasks(List<int> IDs)
        {
            try
            {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            else
            {
                ...
                MAIN_LOOP main_loop = new MAIN_LOOP(Running);
                main_loop.BeginInvoke(null, null);
            }
        }

        protected override void OnStop()
        {
            AddMessageInLog("Stop service...");
        }
    }
}
