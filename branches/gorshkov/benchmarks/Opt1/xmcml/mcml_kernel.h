...
void UpdatePhotonTrajectory(PhotonState* photon, InputInfo* input, OutputInfo* output, PhotonTrjectory* trajectory, 
...
void MovePhotonAndUpdateTrajectory(PhotonState* photon, InputInfo* input, OutputInfo* output, PhotonTrjectory* trajectory);
void MovePhotonOnMinDistanceAndUpdateTrajectory(PhotonState* photon, InputInfo* input, OutputInfo* output, PhotonTrjectory* trajectory);
