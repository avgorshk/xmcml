...
void McmlKernelTestCase::IsCorrectUpdateWeightInDetectors1()
{
    ...
    OutputInfo output;
    output.weightInDetector = new double[input.numberOfDetectors];
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory1()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[0], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory2()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, trajectory[0], delta);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, trajectory[2551], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory3()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[0], delta);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[2551], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory4()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, trajectory[0], delta);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, trajectory[2551], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory5()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, trajectory[0], delta);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[2551], delta);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[5102], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory6()
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(1.0, trajectory[49], delta);
