...
#define BACKUP_PORTION_SIZE 10000000
...
void SendInputToAll(InputInfo* input, int pid)
{
	...
	MPI_Bcast(&(input->startPosition), 3, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	MPI_Bcast(&(input->startDirection), 3, MPI_DOUBLE, 0, MPI_COMM_WORLD);
