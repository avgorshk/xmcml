...
void McmlKernelTestCase::IsCorrectUpdateWeightInDetectors1()
{
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.8, output.weightInDetector[0], delta);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, output.weightInDetector[1], delta);
...
void McmlKernelTestCase::IsCorrectUpdateWeightInDetectors2()
{
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, output.weightInDetector[0], delta);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.8, output.weightInDetector[1], delta);
...
void McmlKernelTestCase::IsCorrectUpdateWeightInDetectorsDoubleCall()
{
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, output.weightInDetector[0], delta);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0 * 0.8, output.weightInDetector[1], delta);
...
void McmlKernelTestCase::IsCorrectUpdateWeightInRingDetectors1()
{
    PhotonState* photon = new PhotonState();
    ...
    OutputInfo output;
	output.numberOfDetectors = input.numberOfCubeDetectors + input.numberOfRingDetectors;
    output.weightInDetector = new double[output.numberOfDetectors];
...
void McmlKernelTestCase::IsCorrectUpdateWeightInRingDetectors2()
{
    PhotonState* photon = new PhotonState();
	...
	CPPUNIT_ASSERT(detectorId == 1);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, output.weightInDetector[0], delta);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.8, output.weightInDetector[1], delta);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, output.weightInDetector[2], delta);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory1()
{
    ...
    int gridSize = area.partitionNumber.x * area.partitionNumber.y * area.partitionNumber.z;
    uint64* trajectory = new uint64[gridSize];
    memset(trajectory, 0, gridSize);

    UpdatePhotonTrajectory(&photon, &input, trajectory, previousPhotonPosition);

    CPPUNIT_ASSERT_EQUAL(1, (int)(trajectory[0]));
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory2()
{
    ...
    CPPUNIT_ASSERT_EQUAL(2, (int)trajectory[0]);
    CPPUNIT_ASSERT_EQUAL(2, (int)trajectory[2551]);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory3()
{
    ...
    CPPUNIT_ASSERT_EQUAL(1, (int)trajectory[0]);
    CPPUNIT_ASSERT_EQUAL(1, (int)trajectory[2551]);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory4()
{
    ...
    CPPUNIT_ASSERT_EQUAL(0, (int)trajectory[0]);
    CPPUNIT_ASSERT_EQUAL(2, (int)trajectory[2551]);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory5()
{
    ...
    CPPUNIT_ASSERT_EQUAL(0, (int)trajectory[0]);
    CPPUNIT_ASSERT_EQUAL(1, (int)trajectory[2551]);
    CPPUNIT_ASSERT_EQUAL(1, (int)trajectory[5102]);
...
void McmlKernelTestCase::IsCorrectUpdatePhotonTrajectory6()
{
    ...
    CPPUNIT_ASSERT_EQUAL(1, (int)trajectory[49]);
