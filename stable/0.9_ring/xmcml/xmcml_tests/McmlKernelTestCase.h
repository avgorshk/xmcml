...
class McmlKernelTestCase : public CppUnit::TestCase
{
	...
	CPPUNIT_TEST(IsCorrectUpdateWeightInRingDetectors1);
	CPPUNIT_TEST(IsCorrectUpdateWeightInRingDetectors2);
...
private:
	...
	void IsCorrectUpdateWeightInRingDetectors1();
    void IsCorrectUpdateWeightInRingDetectors2();
